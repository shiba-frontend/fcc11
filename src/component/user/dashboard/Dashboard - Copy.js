             ...
             <div className="col-lg-3 col-12 col-md-4">
                 <div className="card-listed-rht"> 
                  <div className="split-div">
                    <h6>{moment(item?.game_date).format('DD-MM-YYYY')}, {moment(item?.game_date).format('LT')}</h6>
         ...
         <div className="row align-items-center">
             ...
             <div className="col-lg-3 col-12 col-md-4">
                 ...
                 <h6>{moment(item?.game_date).format('DD-MM-YYYY')}, {moment(item?.game_date).format('LT')}</h6>
                     ...
                     <h3>Team joined: {item?.total_teams}</h3>
                     {tabs == 'full_fledged' &&
                     <NavLink className="btnStyle-three" to={`/fantacy-game-rule/${item?.game_name}/${item?.created_by}/${item?.id}`}>Game Rules</NavLink>   }                           </div>
            </div>
             </div>
         </div>
