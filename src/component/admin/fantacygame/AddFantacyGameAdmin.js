...
const AddHandler = async () => {
    ...
    if(fname == ''){
        ...
        try{
            ...
            const response = await ApiConnection.post("fantasy-game-admin", data);
            if(response.status === 200){
                setloading(false)
  ...
  return (
    <div>
    {loading && <Loader/>}
<DashboardHeader title="Add fantacy game admin" />
<AdminMenu />
...
export default AddFantacyGameAdmin