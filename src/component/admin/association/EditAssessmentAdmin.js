...
const AddHandler = async () => {
    ...
    if(fname == ''){
        ...
        try{
            ...
            const response = await ApiConnection.post(`club-associate/${id}`, data);
            if(response.status === 200){
                setloading(false)
  ...
  return (
    <div>
    {loading && <Loader/>}
<DashboardHeader title="Update league admin" />
<AdminMenu />
...
export default EditAssessmentAdmin