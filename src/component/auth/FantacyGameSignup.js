...
const FantacyGameSignup = () => {
  ...
  GetData()
    ...
    toast.error('Conform password does not match');
          ...
          try{
              const response = await ApiConnection.post('registration/fcc-admin-request', data)
              if(response?.status === 200) {
            ...
            <div className='row no-gutter'>
                ...
                <div className='col-lg-7'>
                        <div className='auth-form'>
                            <h2>Signup as a Fantasy Game Creator</h2>
                            <div className='row'>
...
export default FantacyGameSignup